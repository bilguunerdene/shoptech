        ...
        <div class="uk-card uk-card-default uk-card-body">
            <div>
                ...
                <div style="justify-content:flex-end" class="pcontroller uk-margin uk-text-center uk-flex">
                    <div class=""><div class="addbtn btncontrol uk-border-circle uk-link uk-text-muted" onclick="minusval({{$item->id}},{{$item->cnt}})"><span uk-icon="minus"></span></div></div>
                    <div class=""><input id="inputbtn{{$item->id}}" type="text" class="uk-input inputbtn" value="0"></div>
                    <div class=""><div class="minusbtn btncontrol uk-border-circle uk-link uk-text-muted" onclick="addval({{$item->id}},{{$item->cnt}})"><span uk-icon="plus"></span></div></div>
                </div>
            </div>
        </div>
    </div>
