...
@section('section')
   ...
   <div class="uk-container uk-container-xsmall">
       ...
       <div class="uk-margin">
            <label class="uk-form-label uk-text-right" for="form-horizontal-text">Name:</label>
            <div class="uk-form-controls">
                <input type="text" class="uk-input" disabled value="{{ Auth::user()->name }}">
            </div>
        </div>
        <div class="uk-margin">
                <label class="uk-form-label uk-text-right" for="form-horizontal-text">Email:</label>
                <div class="uk-form-controls">
                    <input type="text" class="uk-input" disabled value="{{ Auth::user()->email }}">
                </div>
            </div>
        <div class="uk-margin">
                <label class="uk-form-label uk-text-right" for="form-horizontal-text">Permission:</label>
                <div class="uk-form-controls">
                    <input type="text" class="uk-input" disabled value="{{ Auth::user()->permissionId }}">
                </div>
            </div>
        <div class="uk-margin">
                <label class="uk-form-label uk-text-right" for="form-horizontal-text">Last login IP address:</label>
                <div class="uk-form-controls">
